    ...
    def __init__(self, game_stats: GameStats):
        ...
        match Config().char["type"]:
            case "sorceress" | "light_sorc":
                self._char: IChar = LightSorc(Config().light_sorc, self._pather, self._pickit) #pickit added for diablo
            case "blizz_sorc":
            ...
            case "hydra_sorc":
                self._char: IChar = HydraSorc(Config().hydra_sorc, self._pather, self._pickit) #pickit added for diablo
